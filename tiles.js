        ...
        value: function buildLinks() {
            ...
            if (this.props.githubLink) {
                retval.push(React.createElement(
                    "a",
                    { href: this.props.infoLink, title: "Project GitHub Page", key: id++ },
            ...
            if (this.props.twitterLink) {
                retval.push(React.createElement(
                    "a",
                    { href: this.props.infoLink, title: "Project Twitter Page", key: id++ },
            ...
            if (this.props.discordLink) {
                retval.push(React.createElement(
                    "a",
                    { href: this.props.infoLink, title: "Project Discord Server", key: id++ },
            ...
            if (this.props.itchLink) {
                retval.push(React.createElement(
                    "a",
                    { href: this.props.infoLink, title: "Itch.io", key: id++ },
            ...
            if (this.props.ggjLink) {
                retval.push(React.createElement(
                    "a",
                    { href: this.props.infoLink, title: "Global Game Jame Website", key: id++ },
                    React.createElement("i", { className: "fas fa-pager" })
                ));
            }
            retval.push(React.createElement(
                "a",
                { href: this.props.pageHref, title: "More Info...", key: id++ },
